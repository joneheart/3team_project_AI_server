...
def nst_apply(key: str, picture: str, img: UploadedFile = File(...)) -> str:
    # key = json.load(key)
    # picture = json.load(picture)
    style_path = tf.keras.utils.get_file(picture + ".jpeg",
                                         f'https://mytest0316.s3.ap-northeast-2.amazonaws.com/base_img/{picture}.jpeg')
    # print(key,picture)
    print(img)
    # 이미지 읽기
    ...
    image_url = upload_tensor_img('mytest0316', stylized_image, key + ".png")
    return image_url
